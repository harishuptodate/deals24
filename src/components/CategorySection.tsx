...
const CategorySection = () => {
  ...
  const categories = [
    ...
    { name: 'Gadgets & Accessories', slug: 'gadgets-accessories', icon: <Headphones size={20} className="mr-2" /> },
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {categories.map((category) => (
            ...
            >
              ...
              <span className="text-xs font-normal text-apple-gray">{getCount(category.slug)} deals</span>
            </Button>
          ))}
        </div>
      </div>
